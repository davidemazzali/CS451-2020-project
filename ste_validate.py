...
if __name__ == '__main__':
    ...
    number_of_processes = int(sys.argv[2])   # Number of messages to send (not present in the membership file)
    ...
    with open(membership_file, 'r') as f:
        for i, l in enumerate(f):
            if i == 0:
                number_of_messages = int(l.split("\n")[0])
    ...
    for i in range(1, number_of_processes+1):
        ...
        with open("logs/proc{:02d}.output".format(i), 'r') as f:
            for l in f:
                #print('bbbbbbbbbbb')
